...
public int health;
	...
	public int stage, countSpawn5, randomNumber;
  ...
  public int dropChance;
    ...
    void Start()
    {
	   ...
	   if(gameObject.transform.GetChild(1).name==("Hand5")){
		   health = stage*15 + 1000;
	   }
	...
	if(GameObject.FindGameObjectWithTag("turret")!=null){
	  ...
	  if(GameObject.FindGameObjectWithTag("Player")==null){
	   ...
	   float angle  = Mathf.Atan2(direction.y, direction.x) * Mathf.Rad2Deg;
		...
		if (animatorStateInfo.IsName("zombie5Death")){
			time -=Time.deltaTime;
